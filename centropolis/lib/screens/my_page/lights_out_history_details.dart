...
class LightsOutHistoryDetails extends StatefulWidget {
  final String type;
  const LightsOutHistoryDetails({super.key, required this.type});

  @override
  State<LightsOutHistoryDetails> createState() =>
      _LightsOutHistoryDetailsState();
}

class _LightsOutHistoryDetailsState extends State<LightsOutHistoryDetails> {
  @override
