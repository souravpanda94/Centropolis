...
class _FitnessTabReservationHistoryState
  ...
  Widget build(BuildContext context) {
    fitnessHistoryListItem =
        Provider.of<FitnessHistoryListProvider>(context).getFitnessHistoryList;
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      if (fitnessHistoryListItem != null &&
                                          fitnessHistoryListItem![index]
                                              .status
                                              .toString()
                                              .isNotEmpty)
  ...
  void loadFitnessHistoryList() async {
    final InternetChecking internetChecking = InternetChecking();
    if (await internetChecking.isInternet()) {
      callFitnessHistoryListApi();
    } else {
  ...
  void callFitnessHistoryListApi() {
    ...
    Future<http.Response> response = WebService().callPostMethodWithRawData(
        ApiEndPoint.fitnessHistoryListUrl, body, language.toString(), apiKey);
    response.then((response) {
      var responseJson = json.decode(response.body);

      debugPrint("server response for Fitness History List ===> $responseJson");
      ...
      if (responseJson != null) {
        if (response.statusCode == 200 && responseJson['success']) {
          ...
          if (page == 1) {
            Provider.of<FitnessHistoryListProvider>(context, listen: false)
                .setItem(fitnessHistoryList);
          } else {
            Provider.of<FitnessHistoryListProvider>(context, listen: false)
                .addItem(fitnessHistoryList);
          }
        } else {
